...
export default function EventCard(props: EventCardProps) {
    ...
    useEffect(() => {
        (async () => {
            // Immediately checking if there might be a thumbnail
    ...
    return (
        <div className={props.className}>
            <div className="bg-white w-full shadow-md rounded-md p-4 transition-transform duration-300 transform hover:scale-105 flex flex-col justify-between relative">
                {props.event["status_id:name"] === "Cancelled" && (
                    <div className="absolute inset-0 bg-gray-500/50 flex items-center justify-center z-10 rounded-md">
